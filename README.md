# Extract Tesseract-Python-Master
...
- Install web interface library in python, flask using this pip command:
  ```
  pip install flask
  ```
# To run the OCR:
- Execute connect.py in Anaconda Navigator or any IDE.
